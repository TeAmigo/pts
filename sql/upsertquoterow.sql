...
CREATE OR REPLACE FUNCTION upsertquoterow(IN sym character varying(15), IN expiry integer,
                                        IN dt timestamp without time zone, IN open double precision,
                                        IN high double precision, IN low double precision, IN close
                                        double precision,
                                        IN vol bigint)
                RETURNS VOID AS
$$
