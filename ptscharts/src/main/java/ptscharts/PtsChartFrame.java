...
//    });
   ...
   *
   * @param chart
   * // RPC DONE 7/21/13 1:02 PM The tooltip disappears too quickly, so extending the DismissDelay
   *
   */
  public void setupChartWindow(PtsChart chart) {
    ...
    int initdelay = chartPanel.getInitialDelay();
    chartPanel.setDismissDelay(300000);       
