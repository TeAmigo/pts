 ...
 * @author rickcharon
 */
public class PtsPaperOrdersList extends JPanel {
...
//    }
  ...
  public JFrame createAndShow() {
    ...
    PtsPaperOrdersList newContentPane = new PtsPaperOrdersList();
...
//    System.out.println("duration = " + (ReadableDuration) (interval.toDuration()));
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        PtsPaperOrdersList pt = new PtsPaperOrdersList();
        JFrame frame = pt.createAndShow();
      }
    });
  }
