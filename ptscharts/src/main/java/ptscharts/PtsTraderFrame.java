/*
 * //rpc - NOTE:9/14/10 1:54 PM - Moved the traderFrame.form to /share/PetrasyBackup, nice for design but gets in the way.
...
public class PtsTraderFrame extends javax.swing.JFrame {
  ...
  // TODO: RPC 4/3/14 5:21 PM This needs a way to remove all of the current trade appearing in the trader  window. 
  // Zero it out.

  /**
   * DONE: 4/3/14 5:15 PM Size of window is way to big. New problem, 
   * probably a change in meaning of screen size or something similar. using setSize() in setLocationAndSize() below.
   */
  
  public void setLocationAndSize() {
    Dimension screen = getToolkit().getScreenSize();
    int height = getSize().height;
    int width = chart.getFrame().getSize().width;
    setSize(width, height);
    setLocation(0, (screen.getSize().height - height + 50));
  }
  ...
  private void initComponents() {
    ...
    tradesSentToIBButton = new javax.swing.JButton();
    ...
    tradesSentToIBButton.setFont(new java.awt.Font("DejaVu Sans", 1, 14));
    tradesSentToIBButton.setText("TradesSentToIB");
    buttonPanel.add(tradesSentToIBButton);

    madeTradesButton.setFont(new java.awt.Font("DejaVu Sans", 1, 14));
    madeTradesButton.setText("MadePaperTrades");
  ...
  private void ExecuteTradeButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    // TODO: RPC 9/17/11 4:16 PM  may be helpful to save crosshairs
...
//    }
  ...
  // DONE: RPC 4/9/14 5:32 PM Fix this so new window gets rid of old. I.e., not more than one open
  private void madeTradesButtonActionPerformed(java.awt.event.ActionEvent evt) {
    if(paperTradesFrame != null) {
      paperTradesFrame.dispose();
    }
    paperTradesFrame = new PtsPaperTradesList().createAndShow();
  }
  ...
  private javax.swing.JButton tradesSentToIBButton;
