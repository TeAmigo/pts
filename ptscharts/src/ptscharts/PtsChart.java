...
//  }
  ...
  // RPC 7/21/13 2:24 PM The HighLowItemLabelGenerator needs to be expanded to show more info, like
  // range. But, when I set the display string for tooltip to a multiline string, the renderer still puts
  // out a single line.
  private CandlestickRenderer getCandlestickRenderer() {
    CandlestickRenderer r = new CandlestickRenderer(2);
    r.setBaseToolTipGenerator(new ToolTipGeneratorForPriceBar());
